...
if(!y){
document.getElementById("demo").innerHTML = "Pirátska verzia softvéru RFID vrátnika! Porušenie licencie! Autor projektu upovedomený pre podniknutie právnych krokov!";
window.alert("Prevádzkovateľ porušil licenciu, ku ktorej sa zaviazal stiahnutím projektu. Vaša IP adresa, údaje o providerovi odoslané autorovi a autorskému úradu pre vyvodenie právnych následkov.");
}
