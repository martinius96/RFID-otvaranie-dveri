...
if(!y){
document.getElementById("demo").innerHTML = "Táto verzia RFID vrátnika je podvodná! Porušenie licencie bolo nahlásené autorovi a autorskému úradu.";
window.alert("Použíteľ RFID vrátnika porušil MIT licenciu a podmienky, s ktorými súhlasil a uvedomuje si svoje povinnosti, aj právne následky. IP adresa bola zaznamenaná a odoslaná autorskému úradu.");
}
